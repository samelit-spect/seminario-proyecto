...
export default function ProductCard({ producto }: { producto: Producto }) {
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-wood-100 bg-white shadow-sm transition-all duration-500 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-wood-900/10">
        ...
        <div className="p-5">
          ...
          <div className="mt-2 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <p className="text-lg font-bold text-wood-700">
      ...
      <button
        ...
        className="pointer-events-auto absolute bottom-16 right-5 flex translate-y-3 items-center gap-1.5 rounded-full bg-gradient-to-r from-wood-500 to-wood-700 px-4 py-2 text-xs font-bold text-chalk opacity-0 shadow-lg transition-all duration-300 hover:brightness-110 active:scale-90 group-hover:translate-y-0 group-hover:opacity-100"
